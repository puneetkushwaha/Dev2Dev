...
const AdminDashboard = () => {
    ...
    const fetchAllData = async () => {
        ...
        const [s, d, u, e, cs, t, iv, n] = await Promise.all([
            safeGet('http://localhost:5000/api/admin/stats', authConfig()),
            safeGet('http://localhost:5000/api/admin/domains', authConfig()),
            safeGet('http://localhost:5000/api/admin/users', authConfig()),
            safeGet('http://localhost:5000/api/admin/exams', authConfig()),
            safeGet('http://localhost:5000/api/admin/corecs', authConfig()),
            safeGet('http://localhost:5000/api/admin/tutorials', authConfig()),
            safeGet('http://localhost:5000/api/interviews/all', authConfig()),
            safeGet('http://localhost:5000/api/notifications', authConfig()),
        ]);
        if (s) setStats(s);
        if (d) setDomains(d);
        if (u) setUsers(u);
    ...
    const fetchTopics = async (domainId) => {
        const res = await axios.get(`http://localhost:5000/api/admin/topics/domain/${domainId}`, authConfig());
        setTopics(res.data);
        return res.data;
    };
    ...
    const saveDomain = async (data) => {
        try {
            if (data._id) await axios.put(`http://localhost:5000/api/admin/domains/${data._id}`, data, authConfig());
            else await axios.post('http://localhost:5000/api/admin/domains', data, authConfig());
            fetchAllData();
    ...
    const deleteDomain = async (id) => {
        ...
        await axios.delete(`http://localhost:5000/api/admin/domains/${id}`, authConfig());
    ...
    const saveTopic = async (data) => {
        try {
            if (data._id) {
                await axios.put(`http://localhost:5000/api/admin/topics/${data._id}`, data, authConfig());
            } else {
                await axios.post('http://localhost:5000/api/admin/topics', data, authConfig());
            }
    ...
    const addTopic = async (defaults) => {
        try {
            const res = await axios.post('http://localhost:5000/api/admin/topics', defaults, authConfig());
            await fetchTopics(universalEditor.domain._id);
            fetchAllData();
            return res.data;
    ...
    const deleteTopic = async (id) => {
        ...
        await axios.delete(`http://localhost:5000/api/admin/topics/${id}`, authConfig());
        await fetchTopics(universalEditor.domain._id);
        fetchAllData();
    };
    ...
    const saveExam = async (data) => {
        try {
            if (data._id) {
                await axios.put(`http://localhost:5000/api/admin/exams/${data._id}`, data, authConfig());
            } else {
                await axios.post('http://localhost:5000/api/admin/exams', data, authConfig());
            }
            setEditingExam(null);
            fetchAllData();
        } catch (err) { alert(err.response?.data?.message || err.message); }
    ...
    const saveTutorial = async (data) => {
        try {
            if (data._id) {
                await axios.put(`http://localhost:5000/api/admin/tutorials/${data._id}`, data, authConfig());
            } else {
                await axios.post('http://localhost:5000/api/admin/tutorials', data, authConfig());
            }
    ...
    const handleDelete = async (type, id) => {
        ...
        await axios.delete(`http://localhost:5000/api/admin/${type}s/${id}`, authConfig());
        fetchAllData();
    };

    const handleToggleRole = async (userId) => {
        await axios.put(`http://localhost:5000/api/admin/users/role/${userId}`, {}, authConfig());
        fetchAllData();
    };
    ...
    const handleCreateNotification = async () => {
        ...
        try {
            await axios.post('http://localhost:5000/api/admin/notifications', newNotification, authConfig());
                            ...
                            <div style={{ height: 'calc(100vh - 90px)', display: 'flex', flexDirection: 'column' }}>
                                <CoreCSManager
                                    ...
                                    onTopicsRefresh={async () => {
                                        const res = await axios.get('http://localhost:5000/api/admin/corecs', authConfig());
