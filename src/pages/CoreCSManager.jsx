...
const CoreCSManager = ({ coreCSTopics, onTopicsRefresh }) => {
    ...
    const getCoreCSdomainId = async () => {
        ...
        const res = await axios.get('http://localhost:5000/api/admin/domains', authConfig());
    ...
    const addProblem = async () => {
        ...
        try {
            ...
            const res = await axios.post('http://localhost:5000/api/admin/topics', {
                domainId,
                isCoreCS: true,
    ...
    const deleteTopic = async (topicName) => {
        ...
        for (const p of probs) {
            await axios.delete(`http://localhost:5000/api/admin/topics/${p._id}`, authConfig());
        }
